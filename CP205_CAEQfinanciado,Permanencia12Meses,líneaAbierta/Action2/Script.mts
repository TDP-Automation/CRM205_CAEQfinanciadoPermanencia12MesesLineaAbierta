...
'			
	...
	If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaList("Tipo de documento:").Exist = true Then
		Dim text
		text = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaEdit("Numero RUC").GetROProperty("text")
		If text = "" Then
		...
		Wend
		Dim enabled
		enabled = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 833910A").JavaEdit("Importe de Cuota Mayor:").GetROProperty("enabled")
		While enabled <> "0"
			wait 1
			enabled = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 833910A").JavaEdit("Importe de Cuota Mayor:").GetROProperty("enabled")
		Wend
